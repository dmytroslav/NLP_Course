...
## 📊 Порівняння результатів (Evaluation Metrics)

| Архітектура / Модель | Accuracy | Macro-F1 | Entity Recall | Valid JSON Rate | Особливості |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **Baseline** (LogReg + Word n-grams) | ~0.8900 | ~0.8500 | N/A | N/A | Вразливість до суржику, проблема Domain Shift. |
| **Tier 1** (LinearSVC + Char n-grams) | **0.9236** | **0.8903** | 0.93 | N/A | Стійкість до одруківок, балансування класів. |
| **Tier 2** (LLM Agent + Repair Loop) | N/A | N/A | N/A | **100%** | Глибокий семантичний аналіз, гарантована цілісність даних. |
